...
class ChatView(QWidget):
    ...
    def _update_document_notice(self) -> None:
        ...
        elif getattr(self, "_chat_type", "normal") == "pdf":
    ...
    def set_waiting(self, waiting: bool) -> None:
        ...
        self.document_controls.setEnabled(not waiting and getattr(self, "_chat_type", "normal") == "pdf")
